...
uniformity(crps)
#> [1] 0.3 0.6 0.5 0.1 0.3
bitaliasing(crps)
#>  [1] 0.6 0.2 0.4 0.2 0.2 0.2 0.2 0.4 0.6 0.6
uniqueness(crps)
#>  [1] 0.5 0.6 0.6 0.4 0.5 0.5 0.3 0.4 0.6 0.6
...
reliability(crps)
#>       [,1] [,2] [,3] [,4] [,5]
#>  [1,] 0.50 0.25 0.50 0.50 0.50
#>  [2,] 0.75 0.50 0.50 0.50 0.25
#>  [3,] 0.50 0.25 0.50 0.25 0.50
#>  [4,] 1.00 0.50 0.50 0.25 0.25
#>  [5,] 0.50 0.00 0.25 1.00 0.25
#>  [6,] 0.50 0.50 0.50 0.75 0.50
#>  [7,] 0.50 0.50 1.00 0.25 0.50
#>  [8,] 0.75 0.25 0.50 0.25 0.50
#>  [9,] 0.50 0.50 0.25 0.25 0.75
#> [10,] 0.50 0.50 0.50 0.75 0.25
```
